...
$dos = array('platform', 'site', 'mc', 'setting', 'ext', 'solution', 'replystatistics', 'hospital');
$do = in_array($do, $dos) ? $do : $do;
$title = array('platform'=>'公众平台','site'=>'微站功能','mc'=>'会员及会员营销','setting'=>'功能选项','ext'=>'扩展功能','solution'=>'行业功能','hospital'=>'医院管理');
